  ...
  <div class="c-modal c-mobile-menu js-tab-mobile-menu" id="mobile-menu">
    <div class="c-tab">
      <div class="c-tab__nav">
        <span :class="{ 'is-active': activeTab === '#wooman' }" @click="toggleTab('#wooman')" class="c-tab__item ">For her</span>
        <span :class="{ 'is-active': activeTab === '#man' }" @click="toggleTab('#man')" class="c-tab__item">For him</span>
      ...
      <div class="c-tab__container">
        <div :class="{ 'is-active': activeTab === '#wooman' }" v-if="data.menu.wooman" class="c-tab__content ">
        ...
        <div :class="{ 'is-active': activeTab === '#man' }" class="c-tab__content">
          <div class="c-mobile-menu__cat">
            <router-link 
